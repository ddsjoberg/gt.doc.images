...
- `save_help_file_images()`: create and save {gtsummary}, {gt}, and {flextable} images from package help files.

- `shrink_help_file_images()`: shrink the help file images using `webshot::shrink()`. Use this function if the help files increase the build size of your package over the CRAN limit of 5MB
